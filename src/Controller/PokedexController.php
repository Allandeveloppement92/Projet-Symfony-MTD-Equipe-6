...
{
    /**
     * @Route("/", name="pokedex_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="pokedex_new", methods={"GET", "POST"})
     */
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('pokedex_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('pokedex/new.html.twig', [
            'pokedex' => $pokedex,
            'form' => $form,
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="pokedex_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="pokedex_edit", methods={"GET", "POST"})
     */
    public function edit(Request $request, Pokedex $pokedex, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('pokedex/edit.html.twig', [
            'pokedex' => $pokedex,
            'form' => $form,
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="pokedex_delete", methods={"POST"})
     */
